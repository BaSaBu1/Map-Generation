...
![Land and Ocean tiles are assigned for 5,000 polygons](figures/land.png){#fig-land}
...
As seen in @fig-biomes, the map is now visually diverse. We see sandy beaches along the coastline, green forests filling the midlands, and white snow capping the highest peaks in the center.
...
As seen in the video, moving to 3D reveals details that were invisible in 2D. We can see the steepness of the mountain summits, the gradual coastlines, and how biomes change based on altitude. Overall, I'm quite happy with what I accomplished before the semester ends.
