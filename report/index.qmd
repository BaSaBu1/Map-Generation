...
![Land and Ocean tiles are assigned](figures/land_ocean.png){#fig-land-ocean}
@fig-land-ocean is a convincing start, it resembles a landmass. However, the land is monochromatic and boring. Real-world terrain is vibrant: we have forests, deserts, snowy peaks, and swamps. In short, we have **biomes**. 
...
Up this point, I'm happy with my 2D map. Debugging and tuning parameters according to my need takes a lot of small changes and tweaks, and it was little annoying to rerun the program everytime I changed a number by 0.1. So, I decided to make an app where I can see the changes in real time without exiting and rerunning the program everytime. Since, I already made the app, I decide to make it public and host it in streamlit, which the link is here.

![FIGURE: Screenshot of the Streamlit app with sidebar controls](images/streamlit-app.png){#fig-app}

[TODO: Refer to @fig-app. Highlight the interactive controls.]

[TODO: Mention it's available online / how to run it]
...
[TODO: What does this parameter control?]

![FIGURE: Three terrains with different noise scales (low, medium, high)](images/noise-scale-effect.png){#fig-noise-scale}

[TODO: Refer to @fig-noise-scale. Describe what changes.]

## Water Level

[TODO: What does this parameter control?]

![FIGURE: Three terrains with different water levels](images/water-level-effect.png){#fig-water-level}

[TODO: Refer to @fig-water-level. Describe what changes.]

## Island Clusters

[TODO: What does this parameter control?]

![FIGURE: Single island vs. archipelago vs. island chain](images/cluster-effect.png){#fig-clusters}

[TODO: Refer to @fig-clusters. Describe what changes.]
